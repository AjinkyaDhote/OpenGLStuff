...
int main()
{
    ...
    float vertices[] = {
    0.0f, 0.0f, 0.0f, /*Common Origin 0*/ 1.0f, 0.0f, 0.0f, /*Red Color*/
    -1.0f, 0.0f, 0.0f, /*Left Vertex  2*/ 0.0f, 1.0f, 0.0f, /*Green Color*/
    -0.5f, 0.5f, 0.0f, /*Top Left     3*/ 0.0f, 0.0f, 1.0f, /*Blue Color*/
    };
